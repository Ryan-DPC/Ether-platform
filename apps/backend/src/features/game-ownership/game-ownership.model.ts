...
export const GameOwnershipModel =
  (mongoose.models.GameOwnership as mongoose.Model<IGameOwnership>) ||
  mongoose.model<IGameOwnership>('GameOwnership', gameOwnershipSchema);
