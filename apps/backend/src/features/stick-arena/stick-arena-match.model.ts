...
export const StickArenaMatchModel: Model<IStickArenaMatch> = mongoose.models.StickArenaMatch || mongoose.model<IStickArenaMatch>('StickArenaMatch', stickArenaMatchSchema);
