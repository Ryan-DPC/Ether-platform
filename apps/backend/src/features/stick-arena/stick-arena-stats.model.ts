...
export const StickArenaStatsModel: Model<IStickArenaStats> = mongoose.models.StickArenaStats || mongoose.model<IStickArenaStats>('StickArenaStats', stickArenaStatsSchema);
