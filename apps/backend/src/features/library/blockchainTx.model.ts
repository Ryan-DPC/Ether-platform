...
const blockchainTxSchema = new Schema<IBlockchainTx>(
  {
    ...
    transaction_type: {
      type: String,
      enum: ['game_purchase', 'game_sale', 'item_purchase', 'game_redemption'],
      required: true,
    },
...
export const BlockchainTxModel: Model<IBlockchainTx> =
  mongoose.models.BlockchainTx || mongoose.model<IBlockchainTx>('BlockchainTx', blockchainTxSchema);
