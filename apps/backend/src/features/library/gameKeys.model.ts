...
const gameKeySchema = new Schema<IGameKey>(
  {
    ...
    purpose: {
      type: String,
      enum: ['purchase', 'dev', 'streamer', 'external', 'promo'],
      default: 'purchase',
    },
...
export const GameKeyModel: Model<IGameKey> =
  mongoose.models.GameKey || mongoose.model<IGameKey>('GameKey', gameKeySchema);
export default GameKeyModel;
