...
export class GameCategoriesService {
     ...
     */
    static async createCategory(userId: string, name: string, icon: string = '📁'): Promise<IGameCategory> {
     ...
     */
    static async assignGame(userId: string, categoryId: string, gameKey: string): Promise<IGameCategory> {
     ...
     */
    static async removeGame(userId: string, categoryId: string, gameKey: string): Promise<IGameCategory> {
        const category = await GameCategory.findOne({
            _id: categoryId,
            user_id: userId
        });
     ...
     */
    static async updateCategory(userId: string, categoryId: string, updates: Partial<{ name: string; icon: string }>): Promise<IGameCategory> {
